...
ActiveRecord::Schema[7.1].define(version: 20_240_123_185_216) do
  ...
  create_table 'motor_audits', force: :cascade do |t|
    ...
    t.index %w[associated_type associated_id], name: 'motor_auditable_associated_index'
    t.index %w[auditable_type auditable_id version], name: 'motor_auditable_index'
    t.index ['created_at'], name: 'index_motor_audits_on_created_at'
    t.index ['request_uuid'], name: 'index_motor_audits_on_request_uuid'
    t.index %w[user_id user_type], name: 'motor_auditable_user_index'
  end
  ...
  create_table 'motor_note_tag_tags', force: :cascade do |t|
    ...
    t.index %w[note_id tag_id], name: 'motor_note_tags_note_id_tag_id_index', unique: true
  ...
  create_table 'motor_notes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[author_id author_type], name: 'motor_notes_author_id_author_type_index'
    t.index %w[record_id record_type], name: 'motor_notes_record_id_record_type_index'
  end
  ...
  create_table 'motor_notifications', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[recipient_id recipient_type], name: 'motor_notifications_recipient_id_recipient_type_index'
    t.index %w[record_id record_type], name: 'motor_notifications_record_id_record_type_index'
  end
  ...
  create_table 'motor_reminders', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[author_id author_type], name: 'motor_reminders_author_id_author_type_index'
    t.index %w[recipient_id recipient_type], name: 'motor_reminders_recipient_id_recipient_type_index'
    t.index %w[record_id record_type], name: 'motor_reminders_record_id_record_type_index'
