...
class InstallMotorAdmin < ActiveRecord::Migration[7.1] # rubocop:todo Metrics/ClassLength, Style/Documentation
  ...
  def self.down # rubocop:todo Metrics/MethodLength
